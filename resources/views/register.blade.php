...
@endpush
@section('postSection')
    <div id="registerPanel" onclick="userExists()">
        <div id="inputForm">
            ...
            {{ csrf_field() }}
                ...
                <div class="g-recaptcha" data-sitekey="6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI" style="margin-top: 20px;"></div>
                <p>
                ...
                <input type="submit" name="reg_done">
            </form>
        </div>
